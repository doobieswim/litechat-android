...
- **Faster than the official app** — native Kotlin + Compose, ~2MB APK

## Features

- Streaming SSE responses with markdown formatting
- `/imagine` — generate images via DALL-E with your key
- `/browse` — fetch and analyze web pages
- `/ocr` — attach images for GPT-4V analysis
- Prompt templates with variables
- Multi-provider support (OpenAI, OpenRouter, Groq, Ollama, LM Studio, any OpenAI-compatible)
- Chat backup/restore
- Floating overlay (chat from any app)
...
*Posted for the community. Not affiliated with the developer.*